...
public final class Util {
	...
	public static Drawable getIcon(Context mContext, File file, boolean online) {
	...
	public static String prepareMeta(FileListEntry file,FileListActivity context,boolean online) {
