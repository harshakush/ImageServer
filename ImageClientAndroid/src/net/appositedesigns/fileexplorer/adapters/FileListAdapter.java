...
public class FileListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.resIcon.setImageDrawable(Util.getIcon(mContext, currentFile.getPath(),currentFile.getOnline()));
        String meta = Util.prepareMeta(currentFile, mContext, currentFile.getOnline());
