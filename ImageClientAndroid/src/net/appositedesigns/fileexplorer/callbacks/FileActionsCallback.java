...
public abstract class FileActionsCallback implements Callback {
	...
	static int[] allOptions = {R.id.menu_copy,R.id.menu_cut, R.id.menu_delete, R.id.menu_props, R.id.menu_share, R.id.upload,R.id.menu_rename, R.id.menu_zip, R.id.menu_unzip};
