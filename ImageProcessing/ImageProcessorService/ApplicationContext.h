#ifndef APP_CONTEXT_HEADER
#define APP_CONTEXT_HEADER
#include <iostream>
#include "tinyxml2.h"
...
public:
	...
	void init() {
		try {
			...
			const char *val_preview_loc = doc.FirstChildElement("ImageServerConfig")->FirstChildElement("PreviewLocation")->GetText();
			string value_previewLoc(val_preview_loc);
			m_previewPath.assign(value_previewLoc.begin(), value_previewLoc.end());
